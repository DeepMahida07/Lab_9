...
frm_INFO = ttk.Label(root, text=('Info'))
frm_INFO.grid(row=1, column=0, padx=(20,10), pady=(10,20))

frm_STAT = ttk.Label(root, text=('Stat'))
frm_STAT.grid(row=1, column=1, padx=(20,10), pady=(10,20))
...
#label_weight.grid(row=5, column=0, padx=(10,5), pady=(10,5), sticky=S)
#label_weight_value = ttk.Label(frm_INFO, width=20)
#label_weight_value.grid(row=3, column=1, padx=(0,10), pady=(10,5), sticky=E)

label_HP = ttk.Label(frm_STAT, text='HP:')
label_HP.grid(row=3, column=1, padx=(10,5), pady=(10,5), sticky=E)
